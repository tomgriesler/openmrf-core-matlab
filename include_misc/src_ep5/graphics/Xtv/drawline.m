...
%   $Revision: 5.25 $  $Date: 2001/02/26 15:12:23 $
...
set(GETLINE_FIG, ...
    'Pointer', 'crosshair', ...
    'WindowButtonDownFcn', 'drawline(''FirstButtonDown'');',...
    'KeyPressFcn', 'drawline(''KeyPress'');', ...
    'DoubleBuffer', 'on');
...
if (~strcmp(get(GETLINE_FIG, 'SelectionType'), 'normal'))
    ...
    set(GETLINE_FIG, 'WindowButtonMotionFcn', 'drawline(''ButtonMotion'');', ...
            'WindowButtonDownFcn', 'drawline(''NextButtonDown'');');
end
