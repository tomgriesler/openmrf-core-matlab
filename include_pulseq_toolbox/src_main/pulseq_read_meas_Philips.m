function [rawdata, study_info, PULSEQ] = pulseq_read_meas_Philips(study)

% Author: Maximilian Gram, University Hospital Wuerzburg, Wuerzburg, Germany; V1, 14.07.2026

% input: only study, which is the path to a .mat file containing Philips rawdata
