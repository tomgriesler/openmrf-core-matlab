...
SPI.NR         = 500;      % [ ]  number of repetitions
...
SPI.spoil_nTwist  = 0 * FOV.Nz;  % [ ] number of 2pi twist in slice
...
%% add sequence blocks
for loop_NR = 1-SPI.Ndummy : 10%SPI.NR
    SPI_add();
end
...
ktraj_adc_full = pulseq_get_ktraj(seq, 1);
